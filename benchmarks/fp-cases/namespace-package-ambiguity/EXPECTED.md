...
Expected behavior: fallow-py reports the module ambiguity. Any related dead-code signal must stay low
confidence.
...
How fallow-py handles it: module ambiguity evidence is emitted in analysis metadata.
