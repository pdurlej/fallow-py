...
Expected behavior: fallow-py may report low-confidence uncertainty elsewhere in the project, but it
...
How fallow-py handles it: the existing Django framework heuristic treats `management/commands` modules
